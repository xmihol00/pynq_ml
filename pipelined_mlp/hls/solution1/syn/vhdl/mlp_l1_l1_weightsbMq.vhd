...
entity mlp_l1_l1_weightsbMq_rom is 
    generic(
             DWIDTH     : integer := 7; 
             AWIDTH     : integer := 10; 
...
architecture rtl of mlp_l1_l1_weightsbMq_rom is 
...
entity mlp_l1_l1_weightsbMq is
    generic (
        DataWidth : INTEGER := 7;
...
architecture arch of mlp_l1_l1_weightsbMq is
    component mlp_l1_l1_weightsbMq_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    mlp_l1_l1_weightsbMq_rom_U :  component mlp_l1_l1_weightsbMq_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
