...
entity mlp_l1_l1_weightstde_rom is 
    generic(
             DWIDTH     : integer := 7; 
             AWIDTH     : integer := 10; 
...
architecture rtl of mlp_l1_l1_weightstde_rom is 
...
entity mlp_l1_l1_weightstde is
    generic (
        DataWidth : INTEGER := 7;
...
architecture arch of mlp_l1_l1_weightstde is
    component mlp_l1_l1_weightstde_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    mlp_l1_l1_weightstde_rom_U :  component mlp_l1_l1_weightstde_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
