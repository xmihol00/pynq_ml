...
entity mlp_l3_l3_weights_3_rom is 
    generic(
             DWIDTH     : integer := 8; 
             AWIDTH     : integer := 6; 
             MEM_SIZE    : integer := 64
...
architecture rtl of mlp_l3_l3_weights_3_rom is 
...
architecture arch of mlp_l3_l3_weights_3 is
    component mlp_l3_l3_weights_3_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    mlp_l3_l3_weights_3_rom_U :  component mlp_l3_l3_weights_3_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
