...
entity mlp_l1_l1_weightsbyn_rom is 
    generic(
             DWIDTH     : integer := 7; 
             AWIDTH     : integer := 10; 
...
architecture rtl of mlp_l1_l1_weightsbyn_rom is 
...
entity mlp_l1_l1_weightsbyn is
    generic (
        DataWidth : INTEGER := 7;
...
architecture arch of mlp_l1_l1_weightsbyn is
    component mlp_l1_l1_weightsbyn_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    mlp_l1_l1_weightsbyn_rom_U :  component mlp_l1_l1_weightsbyn_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
