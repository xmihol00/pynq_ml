...
set C_modelArgList {
	...
	{ l1_in_V int 8 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "in_V_data_V", "interface" : "axis", "bitwidth" : 128, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "l1_in_V", "interface" : "fifo", "bitwidth" : 8, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ l1_in_V_din sc_out sc_lv 8 signal 4 } 
	{ l1_in_V_full_n sc_in sc_logic 1 signal 4 } 
	{ l1_in_V_write sc_out sc_logic 1 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "l1_in_V_din", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "l1_in_V", "role": "din" }} , 
 	{ "name": "l1_in_V_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "l1_in_V", "role": "full_n" }} , 
 	{ "name": "l1_in_V_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "l1_in_V", "role": "write" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4"],
		...
		"Port" : [
			...
			{"Name" : "l1_in_V", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1667", "Max" : "1667"}
	, {"Name" : "Interval", "Min" : "1667", "Max" : "1667"}
]}
...
set Spec2ImplPortList { 
	...
	l1_in_V { ap_fifo {  { l1_in_V_din fifo_data 1 8 }  { l1_in_V_full_n fifo_status 0 1 }  { l1_in_V_write fifo_update 1 1 } } }
}
