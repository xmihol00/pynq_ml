...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("in_r_TDATA", 128, hls_in, 0, "axis", "in_data", 1),
	Port_Property("in_r_TKEEP", 16, hls_in, 1, "axis", "in_data", 1),
	Port_Property("in_r_TSTRB", 16, hls_in, 2, "axis", "in_data", 1),
	Port_Property("in_r_TLAST", 1, hls_in, 3, "axis", "in_data", 1),
	Port_Property("out_r_TDATA", 64, hls_out, 4, "axis", "out_data", 1),
	Port_Property("out_r_TKEEP", 8, hls_out, 5, "axis", "out_data", 1),
	Port_Property("out_r_TSTRB", 8, hls_out, 6, "axis", "out_data", 1),
