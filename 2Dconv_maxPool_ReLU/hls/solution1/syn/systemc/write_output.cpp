...
void write_output::thread_out_r_TDATA_int() {
    out_r_TDATA_int = esl_concat<48,16>(esl_concat<32,16>(esl_concat<16,16>(output_3_V_dout.read(), output_2_V_dout.read()), output_1_V_dout.read()), output_0_V_dout.read());
}
