...
architecture behav of fused_cnn_layer is 
    ...
    "fused_cnn_layer,hls_ip_2020_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=8.702000,HLS_SYN_LAT=443,HLS_SYN_TPT=444,HLS_SYN_MEM=18,HLS_SYN_DSP=12,HLS_SYN_FF=1177,HLS_SYN_LUT=2898,HLS_VERSION=2020_1}";
