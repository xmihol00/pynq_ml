...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { out_r_TREADY { I 1 bit } out_r_TDATA { O 64 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { output_0_V_dout { I 16 vector } output_0_V_empty_n { I 1 bit } output_0_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { output_1_V_dout { I 16 vector } output_1_V_empty_n { I 1 bit } output_1_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { output_2_V_dout { I 16 vector } output_2_V_empty_n { I 1 bit } output_2_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { output_3_V_dout { I 16 vector } output_3_V_empty_n { I 1 bit } output_3_V_read { O 1 bit } } \
} "
}
