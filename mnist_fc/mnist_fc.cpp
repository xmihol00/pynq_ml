...
void mlp_kernel(uint8_t sample[INPUT_SIZE + 1], int32_t prediction[OUTPUT_SIZE])
{
#pragma HLS PIPELINE off

    int8_t l1_weights[L1_SIZE][INPUT_SIZE + 1] = L1_WEIGHTS;
    int8_t l2_weights[L2_SIZE][L1_SIZE + 1] = L2_WEIGHTS;
    int8_t l3_weights[OUTPUT_SIZE][L2_SIZE + 1] = L3_WEIGHTS;

    int32_t l1_out[L1_SIZE + 1] = {0, };
    int32_t l2_out[L2_SIZE + 1] = {0, };
    l1_out[L1_SIZE] = 1;
    l2_out[L2_SIZE] = 1;
