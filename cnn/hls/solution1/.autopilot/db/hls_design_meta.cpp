...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("weights_TDATA", 128, hls_in, 4, "axis", "in_data", 1),
	Port_Property("weights_TVALID", 1, hls_in, 7, "axis", "in_vld", 1),
	Port_Property("weights_TREADY", 1, hls_out, 7, "axis", "in_acc", 1),
	Port_Property("weights_TKEEP", 16, hls_in, 5, "axis", "in_data", 1),
	Port_Property("weights_TSTRB", 16, hls_in, 6, "axis", "in_data", 1),
	Port_Property("weights_TLAST", 1, hls_in, 7, "axis", "in_data", 1),
	Port_Property("out_r_TDATA", 512, hls_out, 8, "axis", "out_data", 1),
	Port_Property("out_r_TVALID", 1, hls_out, 11, "axis", "out_vld", 1),
	Port_Property("out_r_TREADY", 1, hls_in, 11, "axis", "out_acc", 1),
	Port_Property("out_r_TKEEP", 64, hls_out, 9, "axis", "out_data", 1),
	Port_Property("out_r_TSTRB", 64, hls_out, 10, "axis", "out_data", 1),
