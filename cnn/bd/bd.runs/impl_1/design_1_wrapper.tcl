...
namespace eval ::optrace {
  variable script "/mnt/sdc3/david/projs/pynq_ml/cnn/bd/bd.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet /mnt/sdc3/david/projs/pynq_ml/cnn/bd/bd.runs/synth_1/design_1_wrapper.dcp
