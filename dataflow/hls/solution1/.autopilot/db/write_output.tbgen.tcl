...
set C_modelArgList {
	{ l3_out_V int 32 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "l3_out_V", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ l3_out_V_dout sc_in sc_lv 32 signal 0 } 
	{ l3_out_V_empty_n sc_in sc_logic 1 signal 0 } 
	{ l3_out_V_read sc_out sc_logic 1 signal 0 } 
	{ out_r_TDATA sc_out sc_lv 128 signal 1 } 
	{ out_r_TVALID sc_out sc_logic 1 outvld 4 } 
	{ out_r_TREADY sc_in sc_logic 1 outacc 4 } 
	{ out_r_TKEEP sc_out sc_lv 16 signal 2 } 
	{ out_r_TSTRB sc_out sc_lv 16 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "l3_out_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "l3_out_V", "role": "dout" }} , 
 	{ "name": "l3_out_V_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "l3_out_V", "role": "empty_n" }} , 
 	{ "name": "l3_out_V_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "l3_out_V", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4"],
		...
		"Port" : [
			{"Name" : "l3_out_V", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_out_V_data_V_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_out_V_keep_V_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_out_V_strb_V_U", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_out_V_last_V_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	l3_out_V { ap_fifo {  { l3_out_V_dout fifo_data 0 32 }  { l3_out_V_empty_n fifo_status 0 1 }  { l3_out_V_read fifo_update 1 1 } } }
