...
entity mlp_kernel_l3_weibak_rom is 
    generic(
             DWIDTH     : integer := 8; 
             AWIDTH     : integer := 6; 
             MEM_SIZE    : integer := 64
...
architecture rtl of mlp_kernel_l3_weibak_rom is 
...
entity mlp_kernel_l3_weibak is
    generic (
        DataWidth : INTEGER := 8;
...
architecture arch of mlp_kernel_l3_weibak is
    component mlp_kernel_l3_weibak_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    mlp_kernel_l3_weibak_rom_U :  component mlp_kernel_l3_weibak_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
