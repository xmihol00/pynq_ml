...
entity mlp_kernel_l3_weibdk_rom is 
    generic(
             DWIDTH     : integer := 8; 
             AWIDTH     : integer := 6; 
             MEM_SIZE    : integer := 64
...
architecture rtl of mlp_kernel_l3_weibdk_rom is 
...
entity mlp_kernel_l3_weibdk is
    generic (
        DataWidth : INTEGER := 8;
...
architecture arch of mlp_kernel_l3_weibdk is
    component mlp_kernel_l3_weibdk_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    mlp_kernel_l3_weibdk_rom_U :  component mlp_kernel_l3_weibdk_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
