...
HD_PWD='/mnt/sdc3/david/projs/pynq_ml/matmul/vivado/vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log matmul_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source matmul_wrapper.tcl
