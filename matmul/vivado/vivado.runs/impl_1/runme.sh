...
HD_PWD='/mnt/sdc3/david/projs/pynq_ml/matmul/vivado/vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log matmul_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source matmul_wrapper.tcl -notrace
