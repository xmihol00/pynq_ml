...
architecture STRUCTURE of bd_0 is
  ...
  signal hls_inst_out_r_TDATA : STD_LOGIC_VECTOR ( 127 downto 0 );
  signal hls_inst_out_r_TKEEP : STD_LOGIC_VECTOR ( 15 downto 0 );
  signal hls_inst_out_r_TLAST : STD_LOGIC_VECTOR ( 0 to 0 );
  signal hls_inst_out_r_TREADY : STD_LOGIC;
  signal hls_inst_out_r_TSTRB : STD_LOGIC_VECTOR ( 15 downto 0 );
  signal hls_inst_out_r_TVALID : STD_LOGIC;
  signal in_r_0_1_TDATA : STD_LOGIC_VECTOR ( 511 downto 0 );
  signal in_r_0_1_TKEEP : STD_LOGIC_VECTOR ( 63 downto 0 );
  signal in_r_0_1_TLAST : STD_LOGIC_VECTOR ( 0 to 0 );
  signal in_r_0_1_TREADY : STD_LOGIC;
  signal in_r_0_1_TSTRB : STD_LOGIC_VECTOR ( 63 downto 0 );
  ...
  attribute X_INTERFACE_PARAMETER of in_r_tdata : signal is "XIL_INTERFACENAME in_r, CLK_DOMAIN bd_0_ap_clk_0, FREQ_HZ 100000000.0, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 1, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 64, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0";
  ...
  attribute X_INTERFACE_PARAMETER of out_r_tdata : signal is "XIL_INTERFACENAME out_r, CLK_DOMAIN bd_0_ap_clk_0, FREQ_HZ 100000000.0, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 1, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 16, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0";
...
begin
  ...
  in_r_0_1_TDATA(511 downto 0) <= in_r_tdata(511 downto 0);
  in_r_0_1_TKEEP(63 downto 0) <= in_r_tkeep(63 downto 0);
  in_r_0_1_TLAST(0) <= in_r_tlast(0);
  in_r_0_1_TSTRB(63 downto 0) <= in_r_tstrb(63 downto 0);
  in_r_0_1_TVALID <= in_r_tvalid;
  in_r_tready <= in_r_0_1_TREADY;
  interrupt <= hls_inst_interrupt;
  out_r_tdata(127 downto 0) <= hls_inst_out_r_TDATA(127 downto 0);
  out_r_tkeep(15 downto 0) <= hls_inst_out_r_TKEEP(15 downto 0);
  out_r_tlast(0) <= hls_inst_out_r_TLAST(0);
  out_r_tstrb(15 downto 0) <= hls_inst_out_r_TSTRB(15 downto 0);
...
hls_inst: component bd_0_hls_inst_0
     port map (
      ...
      in_r_TDATA(511 downto 0) => in_r_0_1_TDATA(511 downto 0),
      in_r_TKEEP(63 downto 0) => in_r_0_1_TKEEP(63 downto 0),
      in_r_TLAST(0) => in_r_0_1_TLAST(0),
      in_r_TREADY => in_r_0_1_TREADY,
      in_r_TSTRB(63 downto 0) => in_r_0_1_TSTRB(63 downto 0),
