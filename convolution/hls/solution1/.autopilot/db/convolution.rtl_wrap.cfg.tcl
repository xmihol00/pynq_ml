...
set DataType0 [list "ap_axiu<256, 0, 0, 0>" "struct ap_axiu" $structMem0 1 0 $structParameter0 $structArgument0 $NameSpace0 $structIsPacked0]
...
set DataType10 "[list ap_uint 256 ]"
...
set structArgument1 [list 256 0 0 0 ]
set NameSpace1 [list ]
set structIsPacked1 "0"
set DataType1 [list "ap_axiu<256, 0, 0, 0>" "struct ap_axiu" $structMem1 1 0 $structParameter1 $structArgument1 $NameSpace1 $structIsPacked1]
